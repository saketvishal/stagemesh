...
def test_redact_text_leaves_ordinary_text_untouched():
    message = "task GH-caventra-orchestrator-1-T2 escalated COORDINATOR_INVARIANT_FAILURE"
...
def test_watcher_logger_redacts_message_and_writes_jsonl(tmp_path):
    ...
    logger.log(
        ...
        repository_slug="saketvishal/caventra-orchestrator",
        cycle_id="abc123",
    ...
    assert record["repository_slug"] == "saketvishal/caventra-orchestrator"
