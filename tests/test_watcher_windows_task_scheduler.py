...
def test_stable_task_name_is_deterministic_and_scoped():
    name_a = stable_task_name("C:/caventra-orchestrator", "saketvishal/caventra-orchestrator")
    name_b = stable_task_name("C:/caventra-orchestrator", "saketvishal/caventra-orchestrator")
    name_other = stable_task_name("C:/caventra", "saketvishal/caventra")
...
def test_stable_task_name_never_embeds_secrets_or_branch_names():
    name = stable_task_name("C:/caventra-orchestrator", "saketvishal/caventra-orchestrator")
...
def test_task_definition_command_has_no_secrets_in_arguments():
    definition = TaskDefinition(
        ...
        arguments="-m tooling.build_coordinator.cli watcher run --foreground --repo saketvishal/caventra-orchestrator",
        working_directory="C:/caventra-orchestrator",
    )
