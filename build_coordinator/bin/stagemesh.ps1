# Location-independent launcher for the StageMesh CLI.
#
...
# `stagemesh <command>` (or: stagemesh "Continue <project> development.") then works from any directory: the repo root,
...
python -P -m build_coordinator @args
exit $LASTEXITCODE
