...
_FAILURE_PATTERNS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("QUOTA_EXHAUSTED", ("usage limit", "quota", "credit balance", "out of credits", "limit reached", "upgrade your plan")),
    ("RATE_LIMITED", ("rate limit", "429", "too many requests", "overloaded", "try again later")),
    (
        "NETWORK_FAILURE",
