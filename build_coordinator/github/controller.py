...
class GitHubAutonomousController:
    ...
    def __init__(
        ...
        *,
        ...
        default_repo: str = "saketvishal/stagemesh",
        issue_label: str = "build:objective",
    ...
    def _extract_issue_number(self, objective_id: str) -> int | None:
        """Parse issue number from objective ID (e.g. GH-stagemesh-42 -> 42)."""
    ...
    def _ensure_prs_and_pushes(
        ...
        for task in tasks:
            ...
            body = (
                f"Automated PR created by StageMesh Build Coordinator for Task `{task.task_id}`.\n\n"
